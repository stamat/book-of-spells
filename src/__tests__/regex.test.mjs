...
test('RE_VIDEO', () => {
  ...
  expect(RE_VIDEO.test('/video.mov')).toBe(true)
  expect(RE_VIDEO.test('/video.m4v')).toBe(true)
  expect(RE_VIDEO.test('/video.qt')).toBe(true)
  expect(RE_VIDEO.test('/video.MOV')).toBe(true)
  ...
  expect(RE_VIDEO.test('/video.mp4?v=2')).toBe(true)
  expect('/video.mp4?v=2'.match(RE_VIDEO)[1]).toBe("video.mp4")
  expect(RE_VIDEO.test('/video.webm#t=10')).toBe(true)
  expect('/video.webm#t=10'.match(RE_VIDEO)[1]).toBe("video.webm")
  expect(RE_VIDEO.test('/video.mp3')).toBe(false)
  expect(RE_VIDEO.test('/video.mkv')).toBe(false)
